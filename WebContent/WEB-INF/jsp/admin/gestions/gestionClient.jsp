				...
				<div class="card position-relative">
					...
					<div class="card-body">
						...
						<nav class="navbar navbar-expand navbar-light bg-light mb-4">
							<a class="navbar-brand" href="gestionclient">Clients</a>
							<ul class="navbar-nav ml-auto">
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="gestionclient"
							...
							<div class="form-group row">
								...
								<div class="col-sm-6 mb-3 mb-sm-0">
									<label for="type_Personne"></label> <input type="hidden"
										...
										name="type_Personne" value="CLIENT" />
								</div>
								...
								<tbody>
									<c:forEach items="${clients}" var="clients">
										...
										<tr>
											...
											<td><c:out value="${clients.getAdresse_Personne()}" /></td>
											<td><c:out value="${clients.getCp_Personne()}" /></td>
											...
											<td><a
												href="supprimer?id_Personne=${clients.getId_Personne()}&type_Personne=${clients.getType_Personne()}">Supprimer</a></td>
