 ...
 */
@WebServlet("/admin/listeauteur")
public class ServletListeAuteurs extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String VUE = "/WEB-INF/jsp/admin/listes/listeAuteur.jsp";
