 ...
 */
@WebServlet("/admin/listebibliotheque")
public class ServletListeBibliotheque extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String VUE = "/WEB-INF/jsp/admin/listes/listeBibliotheque.jsp";
