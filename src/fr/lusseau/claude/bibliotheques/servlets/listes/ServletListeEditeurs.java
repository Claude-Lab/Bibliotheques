 ...
 */
@WebServlet("/admin/listeediteur")
public class ServletListeEditeurs extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public static final String VUE = "/WEB-INF/jsp/admin/listes/listeEditeur.jsp";
